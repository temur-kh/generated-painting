...
def parse_arguments():
    ...
    parser.add_argument('--epochs', '-e', default=50, type=int, help='Number of evolution epochs.')
    parser.add_argument('--population-size', '-p', default=100, type=int, help='Population size.')
    parser.add_argument('--n-mutations', '-m', default=50, type=int, help='Number of paintings to mutate every epoch.')
    ...
    parser.add_argument('--n-strokes', '-s', default=5000, type=int, help='Number of strokes on a painting.')
    ...
    parser.add_argument('--length-min', default=5, type=int, help='The minimal length allowed.')
    ...
    parser.add_argument('--width-min', default=3, type=int, help='The minimal width allowed.')
    parser.add_argument('--width-max', default=30, type=int, help='The maximal width allowed.')
