...
def parse_arguments():
    ...
    parser.add_argument('--n-mutations', '-m', default=10, type=int, help='Number of paintings to mutate every epoch.')
    ...
    parser.add_argument('--length-min', default=2, type=int, help='The minimal length allowed.')
